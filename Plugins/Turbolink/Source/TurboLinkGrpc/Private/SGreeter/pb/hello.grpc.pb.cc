...
static const char* StreamService_method_names[] = {
  "/Greeter.StreamService/LotsOfReplies",
  "/Greeter.StreamService/BidiHello",
};
...
StreamService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_LotsOfReplies_(StreamService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_BidiHello_(StreamService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}

::grpc::ClientReader< ::Greeter::HelloResponse>* StreamService::Stub::LotsOfRepliesRaw(::grpc::ClientContext* context, const ::Greeter::HelloRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::Greeter::HelloResponse>::Create(channel_.get(), rpcmethod_LotsOfReplies_, context, request);
}

void StreamService::Stub::async::LotsOfReplies(::grpc::ClientContext* context, const ::Greeter::HelloRequest* request, ::grpc::ClientReadReactor< ::Greeter::HelloResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::Greeter::HelloResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_LotsOfReplies_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::Greeter::HelloResponse>* StreamService::Stub::AsyncLotsOfRepliesRaw(::grpc::ClientContext* context, const ::Greeter::HelloRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::Greeter::HelloResponse>::Create(channel_.get(), cq, rpcmethod_LotsOfReplies_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::Greeter::HelloResponse>* StreamService::Stub::PrepareAsyncLotsOfRepliesRaw(::grpc::ClientContext* context, const ::Greeter::HelloRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::Greeter::HelloResponse>::Create(channel_.get(), cq, rpcmethod_LotsOfReplies_, context, request, false, nullptr);
}

::grpc::ClientReaderWriter< ::Greeter::HelloRequest, ::Greeter::HelloResponse>* StreamService::Stub::BidiHelloRaw(::grpc::ClientContext* context) {
  return ::grpc::internal::ClientReaderWriterFactory< ::Greeter::HelloRequest, ::Greeter::HelloResponse>::Create(channel_.get(), rpcmethod_BidiHello_, context);
}

void StreamService::Stub::async::BidiHello(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::Greeter::HelloRequest,::Greeter::HelloResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::Greeter::HelloRequest,::Greeter::HelloResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_BidiHello_, context, reactor);
}

::grpc::ClientAsyncReaderWriter< ::Greeter::HelloRequest, ::Greeter::HelloResponse>* StreamService::Stub::AsyncBidiHelloRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::Greeter::HelloRequest, ::Greeter::HelloResponse>::Create(channel_.get(), cq, rpcmethod_BidiHello_, context, true, tag);
}

::grpc::ClientAsyncReaderWriter< ::Greeter::HelloRequest, ::Greeter::HelloResponse>* StreamService::Stub::PrepareAsyncBidiHelloRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::Greeter::HelloRequest, ::Greeter::HelloResponse>::Create(channel_.get(), cq, rpcmethod_BidiHello_, context, false, nullptr);
}
...
StreamService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< StreamService::Service, ::Greeter::HelloRequest, ::Greeter::HelloResponse>(
          [](StreamService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::Greeter::HelloRequest* req,
             ::grpc::ServerWriter<::Greeter::HelloResponse>* writer) {
               return service->LotsOfReplies(ctx, req, writer);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      StreamService_method_names[1],
      ::grpc::internal::RpcMethod::BIDI_STREAMING,
      new ::grpc::internal::BidiStreamingHandler< StreamService::Service, ::Greeter::HelloRequest, ::Greeter::HelloResponse>(
          [](StreamService::Service* service,
             ::grpc::ServerContext* ctx,
...
::grpc::Status StreamService::Service::LotsOfReplies(::grpc::ServerContext* context, const ::Greeter::HelloRequest* request, ::grpc::ServerWriter< ::Greeter::HelloResponse>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status StreamService::Service::BidiHello(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::Greeter::HelloResponse, ::Greeter::HelloRequest>* stream) {
  (void) context;
  (void) stream;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
}
